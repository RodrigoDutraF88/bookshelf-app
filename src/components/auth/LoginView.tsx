...
export function LoginView() {
  ...
  async function handleDiscordSignIn() {
    setIsLoading(true);
    await signIn("discord", { callbackUrl: "/library" });
  }
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(200,135,58,0.08) 0%, transparent 70%)",
          top: "-100px",
          left: "-150px",
          pointerEvents: "none",
        }}
      ...
      <div
        ...
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(74,124,89,0.07) 0%, transparent 70%)",
          bottom: "-80px",
          right: "-100px",
          pointerEvents: "none",
        }}
      ...
      >
        ...
        <div
          style={{
            ...
            boxShadow:
              "0 24px 64px rgba(44, 24, 16, 0.14), 0 4px 16px rgba(44, 24, 16, 0.08)",
            overflow: "hidden",
          }}
        >
          ...
          <div
            style={{
              height: "3px",
              background:
                "linear-gradient(to right, #4A7C59, #C8873A, #6B8FA8, #B85450, #8B6B8A, #4A7C59)",
            }}
          />
          ...
          <div style={{ padding: "36px 32px 32px" }}>
              ...
              onMouseEnter={(e) => {
                if (!isLoading) {
                  ...
                  e.currentTarget.style.boxShadow =
                    "0 8px 24px rgba(88, 101, 242, 0.40)";
                }
              }}
              onMouseLeave={(e) => {
            ...
            >
              {isLoading ? <SpinnerIcon /> : <DiscordIcon />}
          ...
          <div
            style={{
              ...
              backgroundColor: "rgba(237, 228, 216, 0.60)",
              display: "flex",
              flexDirection: "column",
              gap: "10px",
            }}
  ...
  return (
    ...
    >
      ...
      {SHELF_BOOKS.map((book, i) => {
        ...
        // Slight random tilt for every 4th book
        ...
        return (
          <g
            key={i}
            style={{
              transformOrigin: `${book.x + book.w / 2}px ${SHELF_Y}px`,
              animation: `bob ${2.4 + (i % 4) * 0.3}s ease-in-out ${book.delay}s infinite`,
            }}
          >
      ...
      <rect
        x="4" y={ledgeY + 16}
        width={svgW - 8} height={6}
        rx="2"
        fill="rgba(44,24,16,0.15)"
      />
    </svg>
  );
}
